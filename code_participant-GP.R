...
# Install packages
install.packages("tidyverse") # could start by installing dplyr

# then use tideverse to show something more complex
...
# note the diffrences from read.csv mention why the need for two diff versions
...
# in a provisional way to remain but also mentoin general indexing in the cheat sheet
offenders[500,4]
...
# better explaint he pipe operator in the word document 
# 
# switch the order of explaining the pipe operator. first mention the one liner without thepipe and then with 
...
# possible remove data camp
# include the Rstudio primers
#   in RStudio site 
