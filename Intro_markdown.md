...
You can download the Data Transformation Cheat Sheet (and other cheatsheets) at: https://rstudio.github.io/cheatsheets/html/data-transformation.html
...
1.	Read in dataset 'FTSE_12_14.csv' and convert the variable `Date` to be a date class.
(To read in the data, use the code given in the code_participant.R script) 
...
+ RStudio has developed a list of cheatsheets which give quick overviews of the functions contained in different packages and can be quickly referred to - see: https://posit.co/resources/cheatsheets/
+ RStudio also lists some useful free resources at: https://education.rstudio.com/
+ The 'Hands-On Programming with R' free online book, providing a friendly introduction to R for new programmers: https://rstudio-education.github.io/hopr/
+ The 'R for Data Science' online book: https://r4ds.hadley.nz/, written by Hadley Wickham, Chief Scientist at Posit (formerly RStudio), who developed the tidyverse package. It gives a really good overview of R and how his package works with it.
