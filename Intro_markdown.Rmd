...
The regional_gender_average dataset is grouped by REGION and GENDER. If we want to remove this grouping we can use the ungroup command which in this example, returns the counts of observations in the ungrouped data:
