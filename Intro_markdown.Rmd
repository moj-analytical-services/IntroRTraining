...
R is an open-source programming language and software environment, designed primarily for statistical computing. It has grown rapidly in popularity in the last few years due to increased interest in data science.
...
1. Basic set up - in this section you will be introduced to the RStudio Environment and some of the basic R commands
...
Prior to joining the session, you should ensure you are set up on the Analytical Platform (IT system permitting). https://moj-analytical-services.github.io/platform_user_guidance/getting-started.html.
...
```{r results="hide"}
offenders$DoB_formatted <-  as.Date(offenders$BIRTH_DATE, "%m/%d/%Y")
```
