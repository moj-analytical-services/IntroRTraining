...
## Running a code in this RMarkdown training file

When you want to run code in this training RMarkdown file you have more options to run the code. Put your cursor in a line of code then click the Run button top right. You'll see this menu appear and different ways to run the code you can experiment with.
